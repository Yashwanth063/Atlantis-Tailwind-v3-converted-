    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6 lg:pb-8 relative h-full flex">
        ...
        <div className="h-full flex-grow flex flex-col justify-center items-start pt-24">
          <div
            className="flex flex-col gap-5 max-h-fit max-w-xl overflow-hidden h-full w-full items-center justify-start rounded-[2.375rem] relative px-6 pt-5 pb-6 backdrop-blur backdrop-blur-[3.724rem]"
            style={{
          ...
          >
            ...
            {/* Feedback Content */}
            <div className="flex-1 w-full flex items-center justify-center px-1 overflow-y-auto">
              <div className="w-full max-w-4xl mx-auto">
                <div className="w-full font-rubik font-normal text-[1.188rem] tracking-[-0.007rem] leading-[1.875rem] text-white">
                  <p className="block transition-all duration-300">
                    Correct! Inviting Nova to name her feelings signals genuine
                    interest and creates an opening for her to express herself.
                    This is a core element of empathic listening and emotional
                    intelligence. You're showing openness and making her feel
                    heard, which lays a strong foundation for trust and
                    problem-solving.
                  </p>
                </div>
              </div>
            ...
            {/* Background Ellipse */}
            <div className="absolute h-[30.04rem] left-[11.067rem] mix-blend-lighten top-[1.294rem] w-[33.086rem] pointer-events-none">
              <div className="absolute bottom-[-102.084%] left-[-92.686%] right-[-92.686%] top-[-102.084%]">
                ...
                >
                  <g
                    filter={`url(#filter0_f_feedback_${primaryColor.replace(
                      "#",
                      ""
                    )})`}
                    id="Ellipse 7187"
                  ...
                  <defs>
                    <filter
                      ...
                      height="1461.94"
                      id={`filter0_f_feedback_${primaryColor.replace("#", "")}`}
                      width="1510.68"
                      x="0.34726"
                      y="0.34726"
                    >
                      ...
                      />
                      <feGaussianBlur
                        result="effect1_foregroundBlur_53_81"
...
// Helper Components (same as Interaction.tsx)
const TopNavButton: React.FC<{ icon: string }> = ({ icon }) => {
  ...
  return (
    <Button
      variant="ghost"
      size="sm"
      className="w-12 h-12 !px-0 py-0 relative rounded-2xl hover:scale-110 transition duration-300 group"
      style={{
        borderRadius: "16px",
