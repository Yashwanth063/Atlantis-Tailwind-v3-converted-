...
const Quest: React.FC<{
  ...
  const QuestCard: React.FC<{ quest: QuestData; index: number }> = ({
    ...
    return (
      <div
        className="relative overflow-hidden rounded-[1.25rem] cursor-pointer transition-all duration-300 hover:scale-105"
        style={{
          ...
          <div className="box-border flex flex-row gap-2 items-center justify-start p-4 relative w-full h-full">
            ...
            >
              <div className="flex flex-col items-center relative w-full h-full">
                <div className="box-border flex flex-col gap-0.5 items-center justify-start p-4 relative w-full h-full">
                  {/* Quest Title Section */}
                  <div
                    className="flex flex-row gap-1.5 mt-5 items-center justify-start text-white text-center"
                    style={{
                  ...
                  <div className="flex items-center">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="w-11 h-11 !px-0 py-0 relative rounded-xl"
                      style={{
  ...
  const NavigationArrow: React.FC<{
    ...
    return (
      <Button
        ...
        size="sm"
        onClick={onClick}
        className="w-[3.125rem] h-[2.125rem] py-2 px-4 rounded-[2rem] transition-all duration-200 hover:scale-110"
        style={{
  ...
  return (
    ...
    >
      <div className="w-full px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6 lg:pb-8 relative h-full flex">
        ...
        {/* Quest Content */}
        <div className="h-full flex-grow flex flex-col justify-center items-center pt-5">
          <div
            className="flex flex-col gap-5 max-h-fit max-w-[92vw] lg:min-h-[34.5rem] lg:max-w-[76rem] h-full w-full items-center justify-start rounded-3xl relative px-10 pt-5 pb-4"
            style={{
          ...
          >
            ...
            {/* Quest Cards Grid */}
            <div className="max-lg:hidden flex-1 w-full">
        ...
        >
          ...
          >
            {icon === "coin" ? (
              ...
              <span
                className="text-white font-medium text-[0.813rem] font-rubik tracking-[-0.007rem] drop-shadow-[0px_2.867px_8.6px_rgba(0,255,187,0.30)]"
